...
print('Venezuela' in capitales) # Preguntamos si la llave existe en el diccionario
print('Mexico' in capitales)

# Dictionary Comprehension resourse: https://www.datacamp.com/community/tutorials/python-dictionary-comprehension 